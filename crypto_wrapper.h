...
static constexpr size_t SYMMETRIC_KEY_SIZE_BYTES = 32; // 256 bits
static constexpr size_t HMAC_SIZE_BYTES = 32; // 256 bits
static constexpr size_t SIGNATURE_SIZE_BYTES = 384; // 3072 bits
static constexpr size_t DH_KEY_SIZE_BYTES = 384; // planning to store p, g, pubkey in pubKeyBuffer 3072 bits [ p value is 3072 bits and it can't have more than that ].
